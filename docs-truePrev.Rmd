...
model {
  x ~ dbin(AP, n)
  AP <- SE * TP + (1 - SP) * (1 - TP)
  # SE ~ user-defined (see [here](?main=docs&sub=distributions))
  # SP ~ user-defined (see [here](?main=docs&sub=distributions))
...
An object of class [`prev`](?main=docs&sub=prev-class).
