...
For Uniform, Beta and PERT distributions, BUGS-style short-hand notation is also allowed:

```{r, echo=FALSE, results='asis'}
arg_table(
  uniform = "`~dunif(min, max)`",
  pert = "`~dpert(min, mode, max)`",
